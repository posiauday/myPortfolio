...
export const SAMPLE_FORMULAS = {
  ...
  // tones' bg/fg are plain hex Text, matching IconBg/IconColor's own
  // type — never ColorValue(...)-wrapped like colors above — since the
  // icon SVG substitution needs a literal hex string, not a Color
  // value, and ColorValue() is applied to these at the one or two call
  // sites that actually need a Color (see componentChildren.js's
  // resolvedIconBg/resolvedIconColor). Each pair is the same
  ...
  "Heatmap::ChartData": 'Table({DayOfWeek:0,Hour:6,Value:2},{DayOfWeek:1,Hour:6,Value:3},{DayOfWeek:0,Hour:10,Value:5},{DayOfWeek:1,Hour:10,Value:4},{DayOfWeek:2,Hour:10,Value:8},{DayOfWeek:4,Hour:10,Value:7},{DayOfWeek:0,Hour:12,Value:6},{DayOfWeek:2,Hour:12,Value:7},{DayOfWeek:3,Hour:12,Value:9},{DayOfWeek:4,Hour:12,Value:12},{DayOfWeek:0,Hour:17,Value:10},{DayOfWeek:1,Hour:17,Value:15},{DayOfWeek:2,Hour:17,Value:11},{DayOfWeek:3,Hour:17,Value:18},{DayOfWeek:4,Hour:17,Value:20},{DayOfWeek:6,Hour:20,Value:14})',
  "Heatmap::TimeLabels": 'Table({Hour:6,Label:"6am"},{Hour:10,Label:"10am"},{Hour:12,Label:"12pm"},{Hour:17,Label:"5pm"},{Hour:20,Label:"8pm"})',
