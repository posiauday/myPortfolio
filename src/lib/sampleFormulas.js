...
export const SAMPLE_FORMULAS = {
  ...
  "KPI Card::Data": 'Table({ID:1,Icon:"Box",Value:118,Label:"All Assets",PercentChange:14,PercentLabel:"vs last month",IconBg:"#EBF5FF",IconColor:"#1565C0",SparklineData:"10,25,18,42,38,56,61,70",isHidden:false},{ID:2,Icon:"Warning",Value:1,Label:"Expiring Soon",PercentLabel:"Warranty expiring in less than 30 days",IconBg:"#FFEBEE",IconColor:"#C62828",SparklineData:""})',
  ...
  "KPI Card::ColumnsLayout": "{Mobile:1,Tablet:2,Desktop:4,MobileBreakpoint:IfError(Index(App.SizeBreakpoints,1).Value,640),TabletBreakpoint:IfError(Index(App.SizeBreakpoints,2).Value,1024),DesktopBreakpoint:IfError(Index(App.SizeBreakpoints,3).Value,1366)}",
