...
const overrides = {
  ...
  "deadline-intelligence": {
    ...
    limitations: ["Day-based, not hour-based", "Store the computed due date and reuse it rather than recalculating on every read, or a later holiday-table correction can quietly move a date someone was already given", "TimeZone affects only how StartDate is interpreted; the breakdown sentence itself remains English-only text with no Language()-aware translation"],
    variants: [
